...
// I may phase this out, because some services are very touchy
// if we don't initialize them at the right time, and we can't
// initialize everything at once. Don't ask me why, I couldn't
// begin to explain this phenomenon. -C (2022-08-22)
void initializeThingsWeNeed()
{
...
int main()
{
	...
	mcuInit(); // Notif LED
	nsInit(); // Likely needed, was in old code.
	//hidInit(); // Probably breaks.

	// In some slight variations on this code-flow,
	// this either Sometimes crashes or Always crashes.
	// Why? No idea! But try calling aptExit first
	// if you really need APT. -C (2022-08-22)
	//aptInit();

	// Isn't this already initialized to null?
    socketbuffer_object_pointer = nullptr;

    // This very well may be broken! (:
    if(enable_debug_logging)
    {
    	initSdLogStuff();
    ...
    acInit(); // Init AC Service; Wifi. Don't change this.
